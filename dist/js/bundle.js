...
var _VideoPlayer = __webpack_require__(328);
...
var _Utilities = __webpack_require__(330);

var _WebRTC = __webpack_require__(334);
...
var _appSmallscreen = __webpack_require__(338);
...
var _video = __webpack_require__(329);

var _video2 = _interopRequireDefault(_video);

var _Utilities = __webpack_require__(330);

var _srtWebvtt = __webpack_require__(331);
...
var WebRTC = exports.WebRTC = function () {
	...
	_createClass(WebRTC, [{
		...
		key: 'startVideoCall',
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(isCaller, requestSignal) {
				var _this = this;
					...
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								...
								peerFrom = this.peerConnection[requestSignal.from];

								peerFrom.onicecandidate = function (event) {
								...
								peerFrom.ontrack = function (event) {
								...
								stream.getTracks().forEach(function (track) {
									_this.peerConnection[requestSignal.from].addTrack(track, stream);
								});

								//Create offer when needed
								this.isNegotiating[requestSignal.from] = false;
								peerFrom.onnegotiationneeded = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
									var description;
										...
										while (1) {
											switch (_context.prev = _context.next) {
												...
												case 2:
													...
													_Utilities.Utilities.log("I need it", window.theRemoteDesc);
												...
												case 10:
													...
													_Utilities.Utilities.log("a", isCaller, requestSignal);

													_context.next = 15;
													return peerFrom.setLocalDescription(description);

												case 15:
													_Utilities.Utilities.log("b");

													//if(isCaller){
													_Utilities.Utilities.log('Making offer');
													//Send a call offer
													_this.serverConnection.send(JSON.stringify({
														peerInfo: _Utilities.Utilities.config.peerInfo,
														'from': _Utilities.Utilities.session_identifier,
														'to': requestSignal.from,
														'sdp': _this.peerConnection[requestSignal.from].localDescription,
														'uuid': _this.uuid
													}));
													//}
			...
			function startVideoCall(_x, _x2) {
